...
export default function Home() {
  return (
    <div className="flex flex-col justify-center items-center h-[calc(100vh-4rem)] bg-background text-foreground transition-colors duration-300">
      <div className="flex flex-col my-0 mx-4 p-6 max-sm:p-1 bg-white dark:bg-[var(--darkGray)] border border-gray-300 dark:border-gray-700 rounded-2xl shadow-lg max-w-2xl text-center">
        <h1 className="text-4xl font-bold mb-4 text-gray-800 dark:text-white max-sm:text-xl">
          Проект на Next.js
        </h1>
        <p className="text-lg max-sm:text-sm  text-gray-700 dark:text-gray-300">
        ...
        <p className="mt-4 text-lg max-sm:text-sm font-bold text-gray-700 dark:text-gray-300">
          Реализовано:
        </p>
        <ul className="list-disc list-inside mt-2 text-lg max-sm:text-sm text-gray-700 dark:text-gray-300">
